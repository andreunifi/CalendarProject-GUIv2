    ...
    : QDialog(parent), ui(new Ui::EditActivityDialog)
{
    ...
    connect(this, SIGNAL(emitSegnal(QString)), parent, SLOT(receiveMesg(QString)));
    connect(this, SIGNAL(emitDate(QDate)), parent, SLOT(receiveDate(QDate)));
    connect(this, SIGNAL(emitNewName(QString)), parent, SLOT(receiveNewName(QString)));
    connect(this, SIGNAL(emitNewDesc(QString)), parent, SLOT(receiveNewDesc(QString)));
    connect(this, SIGNAL(emitNewDate(QDateTime)), parent, SLOT(receiveNewStartDate(QDateTime)));
    connect(this, SIGNAL(emitnewEndate(QDateTime)), parent, SLOT(receiveNewEndDate(QDateTime)));
}
